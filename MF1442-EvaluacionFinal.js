export default [
  ...
  },
  {
    ...
    correctAnswer: "b) Preparación de datos y formación del grupo de trabajo.",
    justification:
      "En esta primera etapa del proceso metodológico se prepara la información básica para cada campo de observación.\nEsto permite la puesta en marcha del proceso de identificación de competencias profesionales por parte del grupo de trabajo a partir de los estudios y datos aportados por el INCUAL.\nAdemás, se identifican los perfiles necesarios de los expertos/as que deben constituir los grupos de trabajo, de tal manera que cubran las áreas de competencia del campo, los procesos productivos, las tecnologías inherentes, así como los procesos formativos.\nEstos perfiles se envían a las instituciones representadas en el Consejo General de Formación Profesional para que formulen propuestas, de entre las que se seleccionan las más idóneas.\nTambién se identifican las administraciones competentes y las organizaciones de naturaleza empresarial, sindical o profesional que participarán en la etapa de contraste.",
  },
  {
    question:
  ...
  },
  {
    ...
    correctAnswer:
      "c) Personas trabajadoras, ocupadas y desempleadas aunque no coticen por formación profesional.",
    justification:
      "Esta formación se dirige a estos destinatarios porque:\nFavorece la formación a lo largo de la vida de los trabajadores, mejorando su capacitación profesional y desarrollo personal.\nProporciona los conocimientos y las prácticas adecuadas a las competencias profesionales requeridas en el mercado laboral y a las necesidades de las empresas.\nMejora la empleabilidad, especialmente a los que tienen mayores dificultades de mantenimiento del empleo o de inserción laboral.",
  },
  {
    question:
  ...
  },
  {
    ...
    justification:
      "Algunos errores que solemos cometer al elaborar el cronograma completo y la programación del curso son:\nDiseñarlo como algo cerrado a toda innovación.\nDiseñar las actividades sin bases en que apoyarse.\nOlvidar el colectivo al que se dirige el programa.\nSeparar teoría y práctica.\nEn ocasiones, se potencian aspectos negativos del grupo. Hay que impulsar lo positivo.\nNo se cuenta suficientemente con las personas participantes. Hay que buscar la implicación personal y grupal.",
  },
];
